...
time ./ascii_cpu ../input/Celeste.png;
echo 'Copying outpout file';
cp ascii_cpu.txt ../output;
echo;
echo 'Executing "ascii_gpu"';
time ./ascii_gpu ../input/Celeste.png;
echo 'Copying outpout file';
...
time ./convolution_cpu ../input/Celeste.png;
echo 'Copying outpout file';
cp convolution_cpu.png ../output;
echo;
echo 'Executing "convolution_gpu"';
time ./convolution_gpu ../input/Celeste.png;
echo 'Copying outpout file';
